    ...
    try:
        ...
        if response_base_url.status == 200:
            ...
            try:
                ...
                error_message = response_base_url
        ...
        if response_managers_url.status == 200:
            ...
            try:
                ...
                error_message = response_managers_url
            result = {'ret': False, 'msg': "response managers url Error code %s \nerror_message: %s" % (response_managers_url.status, error_message)}
            return result
        for i in range(manager_count):
            ...
            if response_manager_x_url.status == 200:
                ...
                try:
                    ...
                    error_message = response_manager_x_url
                result = {'ret': False, 'msg': "response managers url Error code %s \nerror_message: %s" % (response_manager_x_url.status, error_message)}
                return result
            ...
            if response_log_services_url.status == 200:
                ...
                try:
                    ...
                    error_message = response_log_services_url
                result = {'ret': False, 'msg': "response_log_services_url Error code %s \nerror_message: %s" % (response_log_services_url.status,error_message)}
                return result
                    ...
                    if "#LogService.ClearLog" in response_log_url.dict["Actions"]:
                        ...
                        if response_clear_log.status in [200, 204]:
                            ...
                            try:
                                ...
                                error_message = response_clear_log
                            result = {'ret': False, 'msg': "response clear log Error code %s \nerror_message: %s" % (response_clear_log.status, error_message)}
