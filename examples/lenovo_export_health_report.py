        ...
        for i in managers_list:
            ...
            if response_servicedata_uri.status == 200:
                ...
                if response_export_health_report_uri.status == 200:
                    ...
                    report_pwd = os.getcwd() + '\\' + health_report_name
                    ...
                    result = {'ret': False, 'msg': "response_export_health_report_uri Error code %s \nerror_message: %s" % (response_export_health_report_uri.status, error_message)}
                    return result
            else:
                try:
