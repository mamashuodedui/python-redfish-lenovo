                ...
                if response_account_x_url.status == 200:
                    ...
                    if bmc_username == username:
                        ...
                        if len(authority) == 1 and authority[0] == "Supervisor":
                            parameter = {"RoleId": "Administrator"}
                        elif len(authority) == 1 and authority[0] == "ReadOnly":
                            parameter = {"RoleId": "ReadOnly"}
                        else:
...
def check_parameter(privileges):
    ...
    custom_privileges_list = ["UserroleManagement", "RemoteConsoleAccess",
...
def add_parameter():
    ...
    help_str += "[UserroleManagement,RemoteConsoleAccess,RemoteConsoleAndVirtualMediaAcccess,RemoteServerPowerRestartAccess,"
    ...
    argget.add_argument('--authority', nargs='*', default='', help=help_str)
